...
- **Полосы на главной переживают переход по меню (#99).** Последняя минута
  приёма, отдачи, CPU и памяти хранится вне страницы: уход в настройки и
  обратно больше не начинает графики с нуля (заполняются они по-прежнему
  только пока главная открыта). Под числом теперь «среднее» словом целиком и
  рядом пиковое значение за ту же минуту — чтобы всплеск было с чем сравнить.
  Линия графика сглажена кривой через те же точки, без выхода за рамку на
  одиночном всплеске.
